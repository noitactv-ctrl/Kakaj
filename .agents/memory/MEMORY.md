...
- [External npm lockfiles](external-npm-lockfiles.md) — Replit lockfile URLs may include a private firewall path; external builds need a public-registry install strategy.
